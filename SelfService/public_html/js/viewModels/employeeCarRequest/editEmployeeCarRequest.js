define(['ojs/ojcore', 'knockout', 'jquery', 'appController', 'ojs/ojtrain', 'config/services', 'ojs/ojbutton', 'ojs/ojinputtext', 'ojs/ojselectcombobox', 'ojs/ojdatetimepicker', 'ojs/ojtimezonedata', 'ojs/ojinputnumber', 'ojs/ojpopup', 'ojs/ojknockout-validation', 'ojs/ojcheckboxset', 'ojs/ojradioset', 'ojs/ojlabel'], function (oj, ko, $, app, commonUtil, services) {
    ...
    function editIdentificationLetters() {
        ...
        ko.postbox.subscribe("editEmployeeCarRequestObj", function (newValue) {
            ...
            self.employeeCarRequestModel.personId(newValue.personId);
            self.employeeCarRequestModel.name(newValue.name);
            self.employeeCarRequestModel.reason(newValue.reason);
            self.employeeCarRequestModel.receiveDate(formatDate(new Date(newValue.receive_date)));
            self.employeeCarRequestModel.returnDate(formatDate(new Date(newValue.return_date)));
            ...
            self.employeeCarRequestModel.status(newValue.status);
            self.employeeCarRequestModel.managerId(newValue.managerId);
        });
        ...
        function editEmployeeCarRequest() {
            if (self.clickedButton() != event.currentTarget.id) {
                ...
                var editEmployeeCarRequestFn = function (data1) {
                ...
                services.editEmployeeCarRequest(jsonData).then(editEmployeeCarRequestFn, app.failCbFn);
            }
        }
        ...
        function initTranslations() {
            ...
            self.comment(getTranslation("others.comment"));
            self.saveDraft(getTranslation("EmployeeCarRequest.saveDraft"));
