...
'ojs/ojpopup','ojs/ojcheckboxset', 'ojs/ojradioset', 'ojs/ojlabel','ojs/ojgauge','ojs/ojdialog'],
        ...
        builTicketsReasonse();
         ...
         self.ticketRequestModel.ticketClass("E");
            ...
            self.setBlanceDate(new Date(self.ticketRequestModel.hireDate()));//100000000650826
             //services.getTotalTicket( "100000000650826", self.blanceStartDate(),self.blanceEndDate(),0).then(getPaaSTotalTicket, app.failCbFn);
...
function getDependentIndex(selctedDepFullName){
   ...
   return selectedIndex ; 
        ...
        function addrewardRequestModelRecord() {   
          ...
          // self.ticketRequestModel.passengerName2(self.ticketRequestModel.passengerName2()[0]);
         //  self.ticketRequestModel.passengerName3(self.ticketRequestModel.passengerName3()[0]);
           //self.ticketRequestModel.passengerName4(self.ticketRequestModel.passengerName4()[0]);
            ...
            services.addNewTicketReqeust(jsonData).then(addRewardRequestCbFn, app.failCbFn);
        }
   ...
   //approvalDataSourceTB2
            var getApprovalList = function (data) {
                ...
                $.each(data.items, function (i, item) {
                    self.approvaldataTB2.push( {
                        name : "Ticket ", type : item.notification_type, status : item.role_type
            ...
            services.getWprkFlowAppovalList('TR').then(getApprovalList, app.failCbFn);
     ...
     this.closeDialog = function () {
        ...
        self.refreshView = ko.computed(function() {
            ...
            function initTranslations() {
               ...
               self.addMessage (getTranslation("ticketRequest.addMessage"));
